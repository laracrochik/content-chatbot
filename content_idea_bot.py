        ...
        if not content_types:
            ...
            if website_content.startswith("Error"):
                ...
                with st.spinner("Analyzing business and generating ideas..."):
                                      ...
                                      Your job is to:
                                      1. Analyze the website to understand: business name, industry, location, what makes them unique, their services/products, target audience, and whether they are a legal/law firm
                    ...
                    Please provide 3-5 ideas for each content type. Make the ideas specific to this business, not generic. If this is a legal client, include ideas around relevant laws in their state/jurisdiction."""
